...
def extract_clip_features(df, image_folder, dataset_name):
    ...
    if not os.path.exists(image_folder):
        print(f"⚠️ No image folder, creating dummy features...")
...
class VisualBERTClassifier(nn.Module):
    def __init__(self, class_weights=None):
        ...
        try:
            ...
            print(f"   ⚠️ Creating from scratch: {e}")
...
def main_pipeline():
    ...
    try:
        ...
        print("👁️ CLIP features properly extracted")
